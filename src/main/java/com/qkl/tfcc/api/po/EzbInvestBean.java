...
import org.apache.commons.lang.builder.ToStringStyle;
 ...
 /**
 * E租宝客户投资明细对象
 * <p>Description：E租宝客户投资明细对象  </p>
 * @project_Name yc_udrs_api
 * @class_Name EzbInvest.java
 * @author weigangpeng
 * @date 2015年4月20日
 * @version v1.0
 */
public class EzbInvestBean implements java.io.Serializable{
	...
	* 投资时间
	*/
	private java.util.Date invest_time;
	/**
	* 支付方式
	*/
	...
	*/
	 ...
	 * @param Long 投资金额  
	 */
	public void setInvest_money(Long value) {
	...
	*/
	public java.util.Date getInvest_time() {
	 ...
	 */
	public void setInvest_time(java.util.Date value) {
		this.invest_time = value;
	}
	...
	*/
	 ...
	 * @param Integer 支付方式  
	 */
	public void setPay_way(Integer value) {
		this.pay_way = value;
	}
	...
	*/
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
			...
			.append("invest_time",getInvest_time())
			.append("pay_way",getPay_way())
