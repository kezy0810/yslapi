...
public interface AccService {
	 ...
	 * @param PageData
	 */
	public boolean addAcc(AccInfo accInfo,String versionNo);
	 ...
	 * @param Page
	 */
	public boolean modifyAcc(AccInfo accInfo,String versionNo);
	/**
	 * 修改用户账户信息
	 * @param modifyAcc
	 * @param Page
	 ...
	 * @param acc
	 */
	public AccInfo findAcc(AccInfo accInfo,String versionNo);
     ...
     * @return: Integer
     */
    public Integer getAvailableBalance(AccInfo accInfo,String versionNo);
    /**
     * @describe:收入
     * @author: zhangchunming
     ...
     * @return: void
     */
    public boolean updateIn(AccInfo accInfo,String versionNo);
    /**
     * @describe:支出
     * @author: zhangchunming
     ...
     * @return: void
     */
    public boolean updateOut(AccInfo accInfo,String versionNo);
