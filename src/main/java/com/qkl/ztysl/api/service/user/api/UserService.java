...
public interface UserService {
	 ...
	 * @throws Exception
	 */
	public Map<String, Object> login(String username, String password, String systemCode,String versionNo);
	/**
	 * 查询锁定登录标识符
	 * @param userCode
	 */
	 ...
	 * @param phone
	 */
	public UserDetail findbyId(Integer userId,String versionNo);
	/**
     * 根据用户编码查询用户
     * @param userCode
     */
